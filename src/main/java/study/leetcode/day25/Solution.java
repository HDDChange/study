...
public class Solution {
     ...
     * @return ListNode
     */
    public ListNode getListNode(int[] ints) {
    ...
    public static void main(String[] args) {
        ...
        ListNode listNode1 = solution.getListNode(new int[] { 1, 2, 4 });
        ListNode listNode2 = solution.getListNode(new int[] { 1, 3, 4 });
